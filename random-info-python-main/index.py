...
if __name__ =="__main__":
    print(random_name())
    print(random_full_name(0))
    print(random_full_name(1))
    print(random_username_name(0))
    print(random_username_name(1))
    print(random_phone())